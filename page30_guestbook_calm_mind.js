...
console.log('page30_guestbook_calm_mind.js v20260816a');
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (guestbookForm) guestbookForm.addEventListener('submit', async (event) => {
        ...
        try {
            const response = await fetch(`${API_BASE_URL}/calm-mind`, {
                method: 'POST',
                headers: {
    ...
    if (editGuestbookForm) editGuestbookForm.addEventListener('submit', async (event) => {
        ...
        try {
            const response = await fetch(`${API_BASE_URL}/calm-mind/updatepost`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json'
                },
    ...
    async function loadMessages(forceRefresh = false) {
        ...
        try {
            const url = `${API_BASE_URL}/calm-mind`;
    ...
    window.deletePost = async function (id) {
        ...
        try {
            const response = await fetch(`${API_BASE_URL}/calm-mind/deletepost`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json'
                },
    ...
    window.editPost = async function (id) {
        ...
        try {
            const response = await fetch(`${API_BASE_URL}/calm-mind/viewpost`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json'
                },
    ...
    window.adminDeletePost = async function (id) {
        ...
        try {
            const response = await fetch(`${API_BASE_URL}/calm-mind/admin/deletepost`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json'
                },
