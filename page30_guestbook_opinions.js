...
console.log('page30_guestbook_opinions.js v20260816a');
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (editGuestbookForm) editGuestbookForm.addEventListener('submit', async (event) => {
        ...
        try {
            const response = await fetch(`${API_BASE_URL}/opinions/updatepost`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json'
                },
    ...
    async function loadMessages(forceRefresh = false) {
        ...
        try {
            const url = `${API_BASE_URL}/opinions`;
    ...
    function renderMessages(messages, container) {
        renderGuestbookTable(container, messages, {
            postPage: 'english-opinions.html',
            apiMode: apiMode,
            board: 'opinions',
            postPath: 'english-opinions',
    ...
    window.deletePost = async function (id) {
        ...
        try {
            const response = await fetch(`${API_BASE_URL}/opinions/deletepost`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json'
                },
    ...
    window.editPost = async function (id) {
        ...
        try {
            const response = await fetch(`${API_BASE_URL}/opinions/viewpost`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json'
                },
    ...
    window.adminDeletePost = async function (id) {
        ...
        try {
            const response = await fetch(`${API_BASE_URL}/opinions/admin/deletepost`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json'
                },
