document.addEventListener('DOMContentLoaded', function() {
    ...
    const keywords = {
        examples:  [
            ...
            "Where is the lavatory?(화장실은 어디인가요?)",
            "Can I have some water?(물 좀 주시겠어요?)",
            "What meals are available on this flight?(이 비행기에서 제공되는 식사는 무엇인가요?)",
            "Can I have some headphones?(헤드폰을 주시겠어요?)",
            "How do I use the in-flight entertainment system?(기내 엔터테인먼트 시스템을 어떻게 사용하나요?)",
            "When will we land?(언제 착륙하나요?)",
