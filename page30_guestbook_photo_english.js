...
console.log('📡 포토영어 API_BASE_URL:', API_BASE_URL);
console.log('page30_guestbook_photo_english.js v20260615');
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (editFormEl) {
        ...
        try {
            const response = await fetch(`${API_BASE_URL}/photo-english-updatepost`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json'
                },
    ...
    async function loadMessages(forceRefresh = false) {
        ...
        try {
            const url = `${API_BASE_URL}/photo-english`;
            ...
            let errorMessage = `요청 URL: <code>${API_BASE_URL}/photo-english</code><br><br>`;
    ...
    window.deletePost = async function (id) {
        ...
        try {
            const response = await fetch(`${API_BASE_URL}/photo-english-deletepost`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json'
                },
    ...
    window.editPost = async function (id) {
        ...
        try {
            const response = await fetch(`${API_BASE_URL}/photo-english-viewpost`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json'
                },
    ...
    window.adminDeletePost = async function (id) {
        ...
        try {
            const response = await fetch(`${API_BASE_URL}/photo-english-admin/deletepost`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json'
                },
