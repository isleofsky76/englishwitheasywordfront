...
window.VIEWPOST_SEO = {
    boardPath: 'situational-english',
    boardLabel: 'Situational English',
    fallbackHtml: 'situational-english.html',
    listPath: '/situational-english',
    bySlugPath: '/situational-english/by-slug',
};
...
async function loadPost() {
    ...
    try {
        if (!window.ViewpostSeo) {
            showError('게시글을 불러올 수 없습니다', 'viewpost-seo.js 가 필요합니다.', 'situational-english-list.html');
            return;
        }
        ...
        if (result.error === 'missing-param') {
            showError('게시글을 찾을 수 없습니다', 'slug 또는 index가 없습니다.', 'situational-english-list.html');
            return;
        }
        if (result.error === 'slug-not-found') {
            showError('게시글을 찾을 수 없습니다', `slug "${result.slug}" 글이 없습니다.`, 'situational-english-list.html');
            return;
        }
        if (result.error) {
            showError('게시글을 불러올 수 없습니다', String(result.error), 'situational-english-list.html');
            return;
        }
