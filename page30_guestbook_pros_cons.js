...
console.log('page30_guestbook_pros_cons.js v20260629');
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (editGuestbookForm) editGuestbookForm.addEventListener('submit', async (event) => {
        ...
        try {
            const response = await fetch(`${API_BASE_URL}/pros-cons/updatepost`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json'
                },
    ...
    async function loadMessages(forceRefresh = false) {
        ...
        try {
            const url = `${API_BASE_URL}/pros-cons`;
    ...
    window.deletePost = async function (id) {
        ...
        try {
            const response = await fetch(`${API_BASE_URL}/pros-cons/deletepost`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json'
                },
    ...
    window.editPost = async function (id) {
        ...
        try {
            const response = await fetch(`${API_BASE_URL}/pros-cons/viewpost`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json'
                },
    ...
    window.adminDeletePost = async function (id) {
        ...
        try {
            const response = await fetch(`${API_BASE_URL}/pros-cons/admin/deletepost`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json'
                },
