...
여기 알려준 단어 말고 새로운 단어로 30개만 더 주세요. 다른 코드는 필요없습니다
ChatGPT
javascript
코드 복사
const words = [
    ...
    { 
        ...
        examples: [
            "Do ghosts exist?",
            "She believes they exist.",
            "He is exploring what exists."
        ]
    },
    { 
        korean: "시도하다", 
        ...
        pronunciation: "[əˈtɛmpt]",
        examples: [
            "I will attempt to finish.",
            "She attempted the exam.",
            "He is attempting a new trick."
        ]
    },
    { 
        korean: "수정하다", 
        english: "Modify", 
        pronunciation: "[ˈmɒdəˌfaɪ]",
        examples: [
            "Can you modify this?",
            "She modified the recipe.",
            "He is modifying his plan."
        ]
    },
    { 
        korean: "생산하다", 
        english: "Produce", 
        pronunciation: "[prəˈdus]",
        examples: [
    ...
    { 
        ...
        examples: [
            ...
            "He is appreciating the support."
        ]
    },
    { 
        korean: "인식하다", 
    ...
    { 
        ...
        examples: [
            ...
            "He is attacking his work."
        ]
    },
    { 
        korean: "연구하다", 
        english: "Research", 
        pronunciation: "[ˈrisɜːrtʃ]",
        examples: [
            "We need to research this topic.",
            "She researched the company.",
            "He is researching the market."
        ]
    },
    { 
        korean: "위험을 감수하다", 
    ...
    { 
        ...
        examples: [
            ...
            "She verified the details.",
            "He is verifying the facts."
        ]
    },
    { 
        korean: "정의하다", 
        ...
        examples: [
            ...
            "She defined the terms.",
            "He is defining his goals."
        ]
    },
    { 
        korean: "연결하다", 
    ...
    { 
        ...
        examples: [
            ...
            "He investigated the case thoroughly."
        ]
    },
    { 
        korean: "분리하다", 
        ...
        examples: [
            "I need to separate these documents.",
            "She separated the groups.",
            "He is separating the items."
        ]
    },
    { 
        korean: "합치다", 
    ...
    { 
        ...
        examples: [
            ...
            "He is consenting to the procedure."
        ]
    },
    { 
        korean: "가정하다", 
    ...
    { 
        ...
        examples: [
            ...
            "He is rejecting the application."
        ]
    },
    { 
        korean: "나타나다", 
    ...
    { 
        ...
        examples: [
            ...
            "He is trying to disappear from sight."
        ]
    },
    { 
        korean: "도착하다", 
    ...
    { 
        ...
        examples: [
            ...
            "She dirtied the floor.",
            "He is dirtying his hands."
        ]
    },
    { 
        korean: "사라지다", 
    ...
    { 
        korean: "감소하다", 
        english: "Decrease", 
        pronunciation: "[ˈdiˌkris]",
        examples: [
            "We need to decrease expenses.",
            "She decreased the volume.",
            "He is decreasing the speed."
        ]
    },
    { 
        korean: "증가하다", 
    ...
    { 
        ...
        examples: [
            ...
            "He is describing his experience."
        ]
    },
    { 
        korean: "결정하다", 
    ...
    { 
        ...
        examples: [
            "We need to distribute the flyers.",
            "She distributed the tasks.",
            "He is distributing the goods."
        ]
    },
    { 
        korean: "도망가다", 
    ...
    { 
        ...
        pronunciation: "[loʊd]",
        examples: [
            "I need to load the truck.",
            "She loaded the dishwasher.",
            "He is loading the software."
        ]
    },
    { 
        korean: "내리다", 
        ...
        examples: [
            "Can you unload the groceries?",
            "She unloaded the boxes.",
            "He is unloading the cargo."
        ]
    },
    { 
        korean: "배우다", 
    ...
    { 
        ...
        examples: [
            "Color the picture.",
            "She colored the page.",
            "He is coloring his drawing."
        ]
    },
    { 
        korean: "써다", 
    ...
    { 
        ...
        examples: [
            "Harvest the crops.",
            "She harvested the vegetables.",
            "He is harvesting the fruits."
        ]
    },
    { 
        korean: "짖다", 
...
function updateWord() {
    ...
    exampleList.innerHTML = ''; // 기존 예문 초기화
    words[currentWordIndex].examples.forEach(example => {
...
function pronounceWord(times, callback) {
    ...
    function speak() {
        if (count < times) {
            ...
            let exampleUtterances = words[currentWordIndex].examples.map(example => {
            ...
            englishUtterance.onend = () => {
                ...
                function speakExamples() {
                    if (exampleIndex < exampleUtterances.length) {
                        synth.speak(exampleUtterances[exampleIndex]);
                        exampleIndex++;
                        setTimeout(speakExamples, 1500); // 각 예문 사이에 0.5초 간격
                    } else {
                        count++;
                        if (count < times) {
                            speak();
