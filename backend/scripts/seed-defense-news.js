...
const article = {
  ...
  intro: [
    '아래는 Defunding the U.S. Military라는 제목의 WSJ 사설에서 추출한 내용입니다. 미국 군사력이 심각한 자금 부족 상태에 빠져 있음을 지적합니다. 트럼프 행정부가 추진하는 국방력 강화 계획이 의회의 자금 지원 부족으로 제대로 추진되지 못하고 있다는 내용입니다.',
  ],
