...
const article = {
  ...
  words: [
    {
      narrative: [
        '1. 수많은 승조원이 한꺼번에 함정을 떠나지 않도록 여러 그룹으로 나눠 순차적으로(**staggered**) 상륙시키고 있었다. cf. staggered 시차를 둔, 시차제의',
      ],
    },
    {
      narrative: [
        '2. 장기간 바다에서 임무를 수행한 승조원들에게 태국 파타야에서의 상륙 허가와(**shore leave**) 자유시간이 주어졌다.',
      ],
    },
    {
      narrative: [
        '3. USS 에이브러햄 링컨 승조원들은 기록적으로 긴 해상 파견 기간(**stint**)을 보낸 뒤 태국에 도착했다. cf. stint 일정 기간 동안의 일·활동',
      ],
    },
    {
      narrative: [
