...
//         try {
//             const response = await fetch(`${API_BASE_URL}/easy-voca`, {
//                 method: 'POST',
//                 headers: {
...
//                 <a href="page30_viewpost_v_easy.html?index=${originalIndex}${apiParam}">${escapeHtml(entry.title || '제목 없음')}</a>
//               </div>
//               <div class="item-meta">
...
//         try {
//             const response = await fetch(`${API_BASE_URL}/easy-voca/admin/deletepost`, {
//                 method: 'POST',
//                 headers: {
//                     'Content-Type': 'application/json'
//                 },
