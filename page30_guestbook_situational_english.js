...
console.log('page30_guestbook_situational_english.js v20260629');
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (guestbookForm) guestbookForm.addEventListener('submit', async (event) => {
        ...
        try {
            const response = await fetch(`${API_BASE_URL}/situational-english`, {
                method: 'POST',
                headers: {
    ...
    if (editGuestbookForm) editGuestbookForm.addEventListener('submit', async (event) => {
        ...
        try {
            const response = await fetch(`${API_BASE_URL}/situational-english/updatepost`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json'
                },
    ...
    // 이미지/동영상 링크를 HTML로 변환 (viewpost와 동일: YouTube는 링크만, href 안 URL은 건드리지 않음)
    ...
    function renderMessages(messages, container) {
        renderGuestbookTable(container, messages, {
            postPage: 'situational-english.html',
            apiMode: apiMode,
    ...
    window.deletePost = async function (id) {
        ...
        try {
            const response = await fetch(`${API_BASE_URL}/situational-english/deletepost`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json'
                },
    ...
    window.editPost = async function (id) {
        ...
        try {
            const response = await fetch(`${API_BASE_URL}/situational-english/viewpost`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json'
                },
    ...
    window.adminDeletePost = async function (id) {
        ...
        try {
            const response = await fetch(`${API_BASE_URL}/situational-english/admin/deletepost`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json'
                },
